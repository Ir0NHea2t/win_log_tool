...
func WriteIntoFile(loginSuccessMapSlice []map[string]string,loginFailMapSlice []map[string]string,usersOperateMapSlice []map[string]string,clearHistoryMapSlice []map[string]string,portInfo string,tasklistInfo string,wmicInfo string){
	file:=xlsx.NewFile()
